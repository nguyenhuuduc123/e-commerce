    ...
    <>
      <header className="header-top-strip py-3">
        <div className="container-xxl">
          <div className="row">
            <div className="col-6">
              <p className='text-white mb-0'> Free shipping over $100 Free Return
              </p>
            </div>
            <div className="col-6">
              <p className='text-end text-white mb-0'>Hotline : <a href="https://www.google.com.vn/">0966916595</a></p>
            </div>
          </div>
        </div>
      </header>
